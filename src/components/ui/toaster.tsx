...
import { ComponentPropsWithoutRef, ElementRef, forwardRef, ReactElement, useEffect, useState } from 'react'
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Title
    ref={ref}
    className={cn('text-xs font-semibold uppercase sm:text-xsm', className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Description
    ref={ref}
    className={cn('line-clamp-3 text-xs opacity-90 sm:text-sm', className)}
    {...props}
  />
))
